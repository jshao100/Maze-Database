				...
				<div class="row">
					...
					<div class="top-bar-right">
						<ul class="menu">
							...
							<li><a href="./login.html" class="button">Login/Sign Up</a></li>
						</ul>
					</div>
				</div>
			</nav>
		...
		<section class="main">
			<div class="medium-6 column">
				<div class="signup-panel">
					...
					<form class="medium-8 medium-push-2">
					...
					<a href="#" class="button medium-2 medium-push-5">Sign Up!</a>
				</div>
			</div>
			<div class="medium-6 column">
				<div class="signup-panel">
					...
					<a href="#" class="button medium-2 medium-push-5">Login In</a>
				</div>
			</div>
		</section>
